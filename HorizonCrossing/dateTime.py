...
#print(convert_time(191962296))
#print(convert_time(5650))

print(f'The dateTime for the 50% crossing is: {convert_time(192224420.12571865)}')
print(f'The dateTime for the (1/e) crossing is: {convert_time(192224394.4300989)}')
print(f'The dateTime for the (2/e) crossing is: {convert_time(192224427.14203405)}')