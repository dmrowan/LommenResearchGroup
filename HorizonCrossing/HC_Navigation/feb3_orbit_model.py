...
G = 6.6743*10**(-11)                                                            # Nm^2/kg^2, Earth's gravitational constant
...
H = 420 #(R_orbit - R*10**3)/(10**3)                                                 # km, altitude of ISS orbit
omega = 2 * np.pi / T                                                           # rad/sec, angular frequency of orbit
...
print('-----')
print('t_180 for feb3_orbitTracking.ipynb:' + str(time0_offset-deltaT_50))
