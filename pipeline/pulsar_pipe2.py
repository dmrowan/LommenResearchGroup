...
def allprocedures(obsID, par, 
    ...
    #Run nicerl2
    if (not pipeline_utils2.check_nicerl2(obsID)) or clobber:
...
def update(sourcename, heasarc_user, heasarc_pwd, decryptkey,
    ...
    #Download new data
    pipeline_utils2.run_datadownload(sourcename, heasarc_user, 
            heasarc_pwd, './', 
    ...
    pipeline_utils2.product_backup(merged_evt, backupdir='evt_backups',
                                  message=message)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-k", help="decryption key", dest='key',
                        action=pipeline_utils2.PasswordPromptAction, 
    ...
    #Option to only download the data with no filtering
        ...
        pipeline_utils2.run_datadownload(args.download,
    ...
    #Back up event file
        ...
        pipeline_utils2.product_backup(args.backup, backupdir='evt_backups',
